...
void util::insere(std::vector <std::vector<unsigned char>> &vec, int a, std::vector<unsigned char> b)
{

	//std::cout<<vec.size()<<std::endl;

	std::vector <std::vector<unsigned char>> vec2 = vec;
	if (a >= vec.size())
	{
		vec.push_back(b);
	}
...
void util::insere(std::vector <unsigned short> &vec, int a, unsigned short b)
{
